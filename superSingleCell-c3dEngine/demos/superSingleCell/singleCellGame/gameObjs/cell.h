...
/*    void addMolecule(Cmolecule*molecule){
    ...
    void waveWing(){
        ...
        this->getModel()->getMeshByIndex(CELLPART_wingL)->getTransformPointer()->setRot(0, 0, 1, cos_A_wing, sin_A_wing);
        this->getModel()->getMeshByIndex(CELLPART_wingR)->getTransformPointer()->setRot(0, 0, 1, cos_A_wing, -sin_A_wing);
    }
    ...
    void legsRot(){//腿旋转
        ...
        getModel()->getMeshByIndex(CELLPART_legs)->getTransformPointer()->rotate(0, 1, 0, cos_v_legsRot, sin_v_legsRot);
    }
