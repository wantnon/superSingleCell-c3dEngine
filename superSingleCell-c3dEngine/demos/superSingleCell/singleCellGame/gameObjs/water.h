...
//    float maxAlpha;//reflectSquare的最大
    ...
    void submitStream_centerSquare(){
        m_centerSquare->getMesh()->getSubMeshByIndex(0)->getIndexVBO()->submitVertex(m_centerSquare->getMesh()->getSubMeshByIndex(0)->getSubMeshData()->vlist,GL_STREAM_DRAW);
        m_centerSquare->getMesh()->getSubMeshByIndex(0)->getIndexVBO()->submitIndex(m_centerSquare->getMesh()->getSubMeshByIndex(0)->getSubMeshData()->IDtriList,GL_STREAM_DRAW);
    ...
    void submitStream_arabesquiticSquare(){
        m_arabesquiticSquare->getMesh()->getSubMeshByIndex(0)->getIndexVBO()->submitVertex(m_arabesquiticSquare->getMesh()->getSubMeshByIndex(0)->getSubMeshData()->vlist,GL_STREAM_DRAW);
        m_arabesquiticSquare->getMesh()->getSubMeshByIndex(0)->getIndexVBO()->submitIndex(m_arabesquiticSquare->getMesh()->getSubMeshByIndex(0)->getSubMeshData()->IDtriList,GL_STREAM_DRAW);
    ...
    void submitStream_reflectSquare(){
        m_reflectSquare->getMesh()->getSubMeshByIndex(0)->getIndexVBO()->submitVertex(m_reflectSquare->getMesh()->getSubMeshByIndex(0)->getSubMeshData()->vlist,GL_STREAM_DRAW);
        m_reflectSquare->getMesh()->getSubMeshByIndex(0)->getIndexVBO()->submitIndex(m_reflectSquare->getMesh()->getSubMeshByIndex(0)->getSubMeshData()->IDtriList,GL_STREAM_DRAW);
