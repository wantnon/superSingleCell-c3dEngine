...
bool CsettingPage::init(){
    ...
    //--quad_settingPage_backGround
    {
        ...
        m_quad_settingPage_backGround->getModelList()[0]->getMeshByIndex(0)->getIndexVBO()->genBuffers();
        m_quad_settingPage_backGround->getModelList()[0]->getMeshByIndex(0)->setTexture(ptex);
    ...
    //----turnOnAudioKey
    {
        ...
        //
        Cc3dTexture* ptex=Cc3dTextureCache::sharedTextureCache()->addImage("data/global/tex/keys/key_audioOn.png");
        float c[2]={0,0};
        m_turnOnAudioKey->genAndInit(c[0]-r_key,c[0]+r_key,c[1]-r_key,c[1]+r_key, 0,1,0,1);
        m_turnOnAudioKey->getModelList()[0]->getMeshByIndex(0)->getIndexVBO()->genBuffers();
        m_turnOnAudioKey->setKeyDownColor(0.7, 0.7, 0.7, 1);
        m_turnOnAudioKey->setKeyUpColor(1, 1, 1, 1);
        m_turnOnAudioKey->useKeyUpColor();
        m_turnOnAudioKey->getModelList()[0]->getMeshByIndex(0)->setTexture(ptex);
        ...
        m_turnOnAudioKey->setKeyDownColor(0.7, 0.7, 0.7, 1);
        m_turnOnAudioKey->setKeyUpColor(1, 1, 1, 1);
        m_turnOnAudioKey->getModelList()[0]->getMeshByIndex(0)->submit(GL_STATIC_DRAW);
        //
    ...
    //----turnOffAudioKey
    {
        ...
        //
        Cc3dTexture* ptex=Cc3dTextureCache::sharedTextureCache()->addImage("data/global/tex/keys/key_audioOff.png");
        float c[2]={0,0};
        m_turnOffAudioKey->genAndInit(c[0]-r_key,c[0]+r_key,c[1]-r_key,c[1]+r_key, 0,1,0,1);
        m_turnOffAudioKey->getModelList()[0]->getMeshByIndex(0)->getIndexVBO()->genBuffers();
        m_turnOffAudioKey->setKeyDownColor(0.7, 0.7, 0.7, 1);
        m_turnOffAudioKey->setKeyUpColor(1, 1, 1, 1);
        m_turnOffAudioKey->useKeyUpColor();
        m_turnOffAudioKey->getModelList()[0]->getMeshByIndex(0)->setTexture(ptex);
        ...
        m_turnOffAudioKey->setKeyDownColor(0.7, 0.7, 0.7, 1);
        m_turnOffAudioKey->setKeyUpColor(1, 1, 1, 1);
        m_turnOffAudioKey->getModelList()[0]->getMeshByIndex(0)->submit(GL_STATIC_DRAW);
        //
...
void CsettingPage::update(){
    ...
    {
        //backKey响应单击
        if(m_backKey->isContainPoint(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint())&&Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsTapOnce()){
        ...
        //backKey响应按下和抬起
        if(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsDown()&&m_backKey->isContainPoint(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint()) ){
    ...
    if(CgameSettings::sharedGameSettings()->getAudioOn()==false){
        //turnOnAudioKey响应单击
        if(m_turnOnAudioKey->isContainPoint(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint())&&Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsTapOnce()){
            CgameSettings::sharedGameSettings()->setAudioOn(true);
            alListenerf(AL_GAIN, 1.0);
        }
        //turnOnAudioKey响应按下和抬起
        if(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsDown()&&m_turnOnAudioKey->isContainPoint(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint()) ){
        ...
        //turnOffAudioKey响应单击
        if(m_turnOffAudioKey->isContainPoint(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint())&&Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsTapOnce()){
            CgameSettings::sharedGameSettings()->setAudioOn(false);
            alListenerf(AL_GAIN, 0.0);
        }
        //turnOffAudioKey响应按下和抬起
        if(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsDown()&&m_turnOnAudioKey->isContainPoint(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint()) ){
