...
bool CdescPage::init(){
    ...
    //--quad_descPage_backGround
    {
        ...
        //
        string imagePathShort="data/global/tex/pageTexs/descPageTex/backGround_";
        ...
        m_quad_descPage_backGround->getModelList()[0]->getMeshByIndex(0)->getIndexVBO()->genBuffers();
        m_quad_descPage_backGround->getModelList()[0]->getMeshByIndex(0)->setTexture(ptex);
        ...
        m_quad_descPage_backGround->getModelList()[0]->setIsWriteDepthBuffer(false);
        m_quad_descPage_backGround->setProgram(Cc3dProgramCache::sharedProgramCache()->getProgramByName("shaderNoLight"));
        m_quad_descPage_backGround->setCallback(passUnifoCallback_noLight);
        //
        m_quad_descPage_backGround->reSetLeftDownCorner(0, 0);
        m_quad_descPage_backGround->getModelList()[0]->getMeshByIndex(0)->submit(GL_STATIC_DRAW);
        //
