...
bool CmenuPage::init(){
    ...
    //--quad_menuPage_backGround
    {
        ...
        m_quad_menuPage_backGround->getModelList()[0]->getMeshByIndex(0)->getIndexVBO()->genBuffers();
        m_quad_menuPage_backGround->getModelList()[0]->getMeshByIndex(0)->setTexture(ptex);
    ...
    //--playKey
    {
        ...
        m_playKey->getModelList()[0]->getMeshByIndex(0)->getIndexVBO()->genBuffers();
        ...
        m_playKey->getModelList()[0]->getMeshByIndex(0)->submit(GL_STATIC_DRAW);
        //
        addChild(m_playKey);
    ...
    //--descKey
    {
        ...
        m_descKey->getModelList()[0]->getMeshByIndex(0)->setTexture(ptexture);
        ...
        m_descKey->getModelList()[0]->getMeshByIndex(0)->submit(GL_STATIC_DRAW);
        //
        addChild(m_descKey);
    ...
    //--settingKey
    {
        ...
        m_settingKey->getModelList()[0]->getMeshByIndex(0)->setTexture(ptexture);
        ...
        m_settingKey->getModelList()[0]->getMeshByIndex(0)->submit(GL_STATIC_DRAW);
        //
    ...
    //--aboutKey
    {
        ...
        m_aboutKey->getModelList()[0]->getMeshByIndex(0)->setTexture(ptexture);
        ...
        m_aboutKey->getModelList()[0]->getMeshByIndex(0)->submit(GL_STATIC_DRAW);
        //
        addChild(m_aboutKey);
    }
    //----switchPage
...
void CmenuPage::update(){
    //----playKey
    {
        ...
        //playKey响应单击
        if(m_playKey->isContainPoint(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint())&&Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsTapOnce()){
        ...
        //playKey响应按下和抬起
        if(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsDown()&&m_playKey->isContainPoint(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint()) ){
    ...
    {
        //descKey响应单击
        if(m_descKey->isContainPoint(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint())&&Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsTapOnce()){
            this->getALSourceByName("switchPage")->play();
        ...
        //descKey响应按下和抬起
        if(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsDown()&&m_descKey->isContainPoint(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint()) ){
    ...
    {
        //aboutKey响应单击
        if(m_aboutKey->isContainPoint(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint())&&Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsTapOnce()){
            this->getALSourceByName("switchPage")->play();
        ...
        //aboutKey响应按下和抬起
        if(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsDown()&&m_aboutKey->isContainPoint(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint()) ){
    ...
    {
        //settingKey响应单击
        if(m_settingKey->isContainPoint(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint())&&Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsTapOnce()){
            this->getALSourceByName("switchPage")->play();
        ...
        //settingKey响应按下和抬起
        if(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsDown()&&m_settingKey->isContainPoint(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint()) ){
