...
bool CaboutPage::init(){
    ...
    //--quad_aboutPage_backGround
    {
        ...
        m_quad_aboutPage_backGround->getModelList()[0]->getMeshByIndex(0)->getIndexVBO()->genBuffers();
        m_quad_aboutPage_backGround->getModelList()[0]->getMeshByIndex(0)->setTexture(ptex);
        ...
        m_quad_aboutPage_backGround->getModelList()[0]->setIsWriteDepthBuffer(false);
        //
        m_quad_aboutPage_backGround->reSetLeftDownCorner(0, 0);
        m_quad_aboutPage_backGround->getModelList()[0]->getMeshByIndex(0)->submit(GL_STATIC_DRAW);
        //
