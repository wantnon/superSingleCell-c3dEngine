...
void  CplayingPage::update(){
    ...
    this->logic();
    //------------响应按键
    vector<Ckey*> pKeyList;//按键列表
    {
        //----pauseKey
        pKeyList.push_back(m_pauseKey);
        //pauseKey响应单击
        if(m_pauseKey->isContainPoint(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint())&&Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsTapOnce()){
        ...
        //pauseKey响应按下和抬起
        if(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsDown()&&m_pauseKey->isContainPoint(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint())){
        ...
        //debugKey响应单击
        if(m_debugKey->isContainPoint(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint())&&Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsTapOnce()){
            this->debugSwitch();
        }
        //debugKey响应按下和抬起
        if(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsDown()&&m_debugKey->isContainPoint(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint()) ){
        ...
        //tipKey响应单击
        if(m_tipKey->isContainPoint(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint())&&Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsTapOnce()){
        ...
        //tipKey响应按下和抬起
        if(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsDown()&&m_tipKey->isContainPoint(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint())){
        ...
        //zoomOutKey响应按下和抬起
        if(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsDown()&&m_zoomOutKey->isContainPoint(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint()) ){
        ...
        if(m_cell->get_onShip()){
            //goDownShipKey响应单击
            if(m_goDownShipKey->isContainPoint(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint())&&Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsTapOnce()){
                Cship*pship=m_cell->get_ship();
                if(m_cell->get_ship()->getALSourceByName("shipEngineSound")){
                    m_cell->get_ship()->getALSourceByName("shipEngineSound")->stop();//飞船停止声音,必须放在getDownShip之前
                }
                m_cell->getDownShip();//下船
                ...
                m_cell->getTransformPointer()->moveRelativeToFather(up.x(), up.y(), up.z());
                m_cell->doJump(2.5/2);
            }
            //goDownShipKey响应按下和抬起
            if(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsDown()&&m_goDownShipKey->isContainPoint(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint())){
     ...
     //       }
            if(m_shotKey->isContainPoint(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint()) &&Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsTapOnce()){
            ...
            //shotKey按下抬起
            if(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsDown()&&m_shotKey->isContainPoint(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint())){
        ...
        {
            if(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsTapOnce()&&m_shotBigKey->isContainPoint(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint()) ){
            ...
            //shotBigKey按下和抬起
            if(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsDown()&&m_shotBigKey->isContainPoint(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint()) ){
    ...
    bool usingKey=false;
    {
        ...
        for(int i=0;i<nKey;i++){
            ...
            if(pKey->isContainPoint(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint())){
                usingKey=true;
                break;
            }
        }//得到usingKey
    ...
    //----------------------手势
    {
        ...
        if(m_cell->get_onShip()){
            //下滑
            if(usingKey==false&&Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsDown()
               &&fabs(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint().x()-Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getLatestTouchBeganPoint().x())<maxf( 10,Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getLatestTouchBeganPoint().y())
               &&Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getLatestTouchBeganPoint().y()-Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint().y()>10){
        ...
        if(m_cell->get_onShip()){
            //上滑
            if(usingKey==false&&Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsDown()
               &&fabs(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint().x()-Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getLatestTouchBeganPoint().x())<maxf(10,Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint().y()-Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getLatestTouchBeganPoint().y())
               &&Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint().y()-Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getLatestTouchBeganPoint().y()>10){
        ...
        //----rotKey
        {
            //左右滑
            if(usingKey==false&&Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsDown()
               &&fabsf(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint().y()-Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getLatestTouchBeganPoint().y())<maxf(20,2*fabsf(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint().x()-Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getLatestTouchBeganPoint().x()))
               &&fabsf(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint().x()-Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getLatestTouchBeganPoint().x())>6){
                //inputSignal.rotKeyDown.set(true);
                m_cell->rotSignal=true;
            }
            if(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsDown()==false){
        ...
        if(m_cell->get_onShip()==false){
            ...
            if(usingKey==false&&Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsDown()
               &&fabs(Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint().x()-Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getLatestTouchBeganPoint().x())<maxf(10,Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getLatestTouchBeganPoint().y())
               &&Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getLatestTouchBeganPoint().y()-Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getPoint().y()>6){
        ...
        {
            int span=2;
            if(usingKey==false&&m_cell->isTouchSurface(3.0)==false&&Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsDown()
               &&Cc3dTimeCounter::sharedTimeCounter()->getCount()-Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getLatestTouchBeganTime()>span
        ...
        //----forward
        //一定要放在最后，因为可能需要使用其它的inputSignal进行控制
        {
   //         cout<<"touch move speed: "<<Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getTouchMoveSpeed().x()<<" "<<Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getTouchMoveSpeed().y()<<endl;
            //如果Cc3dGestureAnalyzer::sharedGestureAnalyzer()->isDown==true且time_down到现在大于span，且从time_down到现在所有的坐标都局限在一个较小的范围内
            //则认为是一直按住一点
            long latestTouchBeganTime=Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getLatestTouchBeganTime();
            long downTime=Cc3dTimeCounter::sharedTimeCounter()->getCount()-latestTouchBeganTime;
      ...
      */
            ...
            if(usingKey==false
               ...
               &&Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getIsDown()
               &&downTime>span
               ){
                long timeRef=Cc3dGestureAnalyzer::sharedGestureAnalyzer()->getLatestTouchBeganTime();
                //求Cc3dGestureAnalyzer::sharedGestureAnalyzer()->posList中所有时间戳在timeRef之后者的坐标范围
                float xmin=c3d_INF;
                float ymin=c3d_INF;
                float xmax=-c3d_INF;
                float ymax=-c3d_INF;
                int count_laterThanTimeRef=0;//晚于timeRef的坐标的个数
                const vector<Cc3dTouch> posList=Cc3dTouchSequence::sharedTouchSequence()->getTouchList();
                int nPos=(int)posList.size();
                for(int i=0;i<nPos;i++){
                    const Cc3dTouch&xy=posList[i];
        ...
        //        cout<<"range:"<<xmin<<" "<<xmax<<" "<<ymin<<" "<<ymax<<endl;
                ...
                if(count_laterThanTimeRef==0
                   ...
                   ){//如果最近span时间内没有坐标变化，或者此间坐标变化范围较小，则认为是按住一点不动
    ...
    //------------游戏结束或过关
    if(this->getIsGameOver()){//没血了且已从摔扁恢复
   //     gameState=GAME_STATE_gameover;
        Cc3dAudioCache::sharedAudioCache()->stopAllPlayingSource();//停止所有声音
        this->getALSourceByName("gameOver")->play();//gameOver声音
        //--
    ...
    if(this->getIsSucc()){
     //   gameState=GAME_STATE_succeed;
        Cc3dAudioCache::sharedAudioCache()->stopAllPlayingSource();//停止所有声音
        this->getALSourceByName("levelDone")->play();//播放胜利声音
        //计算本关获得星数，并更新gameKeyList_star的相应元素
        ...
        int nStar;//获得星数
        {
            ...
            float divee=(float)(nEnemyKilledCount+nCoinEatenCount);//被除数
            float diver=(float)(nBoss+nCoin);//除数
        ...
        //解锁下一关并写入文件
        if(CgameSettings::sharedGameSettings()->getUnlockAll()==false){//在unlockAll开启的情况下解锁的关卡不存储，将来还得再解
            ...
            CuserConfig::sharedUserConfig()->writeToConfigFileInDocuments("userConfig.txt");
        }
        //输出userConig内容
...
bool  CplayingPage::init(int level){
    ...
    //核颜色
    m_cell->getModelList()[CELLPART_core]->setDiffuseRGB(0.7,0,0);
    ...
    int nReuseALSourcePercentage=0.9;//重用ALSource的比例
    int j=0;
    while(1){
  ...
  //  assert(cell->getFather()==NULL);
    ...
    m_cell->isJump.set(true);//cell起初是跳起的
    ...
    //创建fireList
    {
        ...
        const int nFire=3;
        //fireList中各元素的大小
        vector<float> rxList(nFire),ryList(nFire);//(rxList[i],ryList[i])为cell.pmoleculeList[i]的横纵边心距
        ...
        for(int i=0;i<nFire;i++){
            ...
            pmolecule->getModel()->getMeshByIndex(0)->submitVertex(GL_STATIC_DRAW);
    ...
    //--shadowMap
    {
        ...
        lightViewCamera->setzNear(600);//近截面在保证不裁掉物体的前提下尽量取大些，能更允分利用深度纹理的精度
        ...
        lightViewCamera2->setzNear(600);//近截面在保证不裁掉物体的前提下尽量取大些，能更允分利用深度纹理的精度
    ...
    
    {
        ...
        if(haveWater){
            ...
            m_water->getModel()->setDiffuseAlpha(0.5);
            //preflectSquare
            {
    ...
    if(landClipExist&&landMapExist)
    {
        ...
        m_ground->init(rootPath+"/land/land.bmp",rect,m_ground->getHeightScale(),9,texture);
        m_ground->setUVScale(1);
        m_ground->getModel()->setDiffuseRGB(1, 1, 1);
        ...
        m_ground->getModel()->getMeshByIndex(0)->clearMeshData();
    ...
    //seabed
    {
        ...
        if(seabedTexExist){
            ...
            m_seabed->getModelList()[0]->setDiffuseRGB(1, 1, 1);
            m_seabed->getModelList()[0]->setAmbient(1, 1, 1);
    ...
    //--archScene
    {
        ...
        m_archScene->getModel()->setDiffuseRGB(0.8, 0.8, 0.8);
        m_archScene->getModel()->setAmbient(0.5, 0.5, 0.5);
    ...
    //----shotBlastSet
    {
        ...
        for(int i=0;i<nBlastTotal;i++){
            ...
            m_shotBlastSet.addActor((Cc3dModel*)pblast);
        }
    ...
    //----bubbleBlastSet
    {
        ...
        for(int i=0;i<n;i++){
            ...
            pblast->useTex(0);
            pblast->getModel()->submit(GL_STATIC_DRAW);
            m_bubbleBlastSet.addActor((Cc3dModel*)pblast);
        }
    }
    ...
    //--mobilePlatformSet
    {
        ...
        for(int i=0;i<nPlat;i++){
            ...
            if(pmobilePlatform->geoTypeName=="cube_program"){//程序生成cube
                ...
                pmesh->init();
                pmesh->autorelease();
                pmobilePlatform->getModel()->addMesh(pmesh);
                Cc3dMeshData*meshData=genSampleCubeWithCode(0, 0, 0, pmobilePlatform->rx,pmobilePlatform->ry, pmobilePlatform->rz,
            ...
            //----设置texture
            //判断是用platformTexLibrary中的贴图还是用自带贴图
            ...
            for(int i=0;i<nMesh;i++){
                Cc3dMesh*pmesh=pmobilePlatform->getModel()->getMeshByIndex(i);
                reCalNorms_precise_normByFace(pmesh->getMeshData());
       //         pmesh->setMeshData());
                //存储顶点
                pmobilePlatform->vlistStoreList.push_back(pmesh->getMeshData()->vlist);
       //        pmesh->store_vlist();
                //生成vbo缓冲并提交顶点
                pmesh->getIndexVBO()->genBuffers();
                pmesh->submit(GL_STATIC_DRAW);
            }
            pmobilePlatform->getModel()->setDiffuseRGB(0.8, 0.8, 0.8);
            pmobilePlatform->getModel()->setAmbient(0.5,0.5,0.5);
            ...
            //初始化IDboard
            {
                ...
                IDboard0->init(10, 10);
                IDboard0->getModel()->setColor(0.7, 0.7, 1, 1);
                IDboard0->getModel()->getMeshByIndex(0)->getIndexVBO()->genBuffers();
                IDboard0->getModel()->getMeshByIndex(0)->setTexture(m_numberTexList[(ID/10)%10]);
                ...
                IDboard1->init(10, 10);
                IDboard1->getModel()->setColor(0.7, 0.7, 1, 1);
                IDboard1->getModel()->getMeshByIndex(0)->getIndexVBO()->genBuffers();
                IDboard1->getModel()->getMeshByIndex(0)->setTexture(m_numberTexList[ID%10]);
    ...
    //----bubbleSet
    {
        ...
        for(int i=0;i<nBubble;i++){
            ...
            pmolecule->getModel()->getMeshByIndex(0)->submitIndex(GL_STATIC_DRAW);
            pmolecule->getModel()->getMeshByIndex(0)->submitVertex(GL_STATIC_DRAW);
            for(int j=0;j<(int)pmolecule->getModel()->getMeshCount();j++){
                pmolecule->getModel()->getMeshByIndex(j)->setName("molecule mesh j");
            }
            ...
            //初始化IDboard
            {
                ...
                IDboard0->init(10, 10);
                IDboard0->getModel()->setColor(1, 1, 0, 1);
                IDboard0->getModel()->getMeshByIndex(0)->getIndexVBO()->genBuffers();
                IDboard0->getModel()->getMeshByIndex(0)->setTexture(m_numberTexList[(ID/10)%10]);
                IDboard0->getModel()->getMeshByIndex(0)->submit(GL_STATIC_DRAW);//submitIndex(GL_STATIC_DRAW);
                IDboard0->getModel()->setIsDoDepthTest(false);
                ...
                IDboard1->init(10, 10);
                IDboard1->getModel()->setColor(1, 1, 0, 1);
                IDboard1->getModel()->getMeshByIndex(0)->getIndexVBO()->genBuffers();
                IDboard1->getModel()->getMeshByIndex(0)->setTexture(m_numberTexList[ID%10]);
                IDboard1->getModel()->getMeshByIndex(0)->submit(GL_STATIC_DRAW);//submitIndex(GL_STATIC_DRAW);
                IDboard1->getModel()->setIsDoDepthTest(false);
    ...
    //----bossCellSet
    {
        ...
        for(int i=0;i<nBoss;i++){
            ...
            if(pbossCell->get_isFly()){
                pbossCell->life.set_maxValue(4);//由于飞行boss不容易打中，所以将其生命值设小些
            }else{
    ...
    //----levelBackGroundMusicCube
    {
        ...
        m_levelBackGroundMusicCube->init();
        ...
        //    m_levelBackGroundMusicCube->getALSourceByName("levelbackGroundMusic")->updatePosition(m_levelBackGroundMusicCube->sourcePos);
            ...
            //更新musicCube位置
            m_levelBackGroundMusicCube->getTransformPointer()->setPos(m_levelBackGroundMusicCube->sourcePos.x(),
    ...
    //碰撞墙的范围小些，对减小网格尺寸有帮助
    {
        ...
        float d_ccell=maxRc;//格子边长
        //boss的碰撞网格范围为碰撞墙(cbTri)范围再并上各bossShip的活动范围
        ...
        //检查是否有地面bossCell出界（飞行bossCell出界没关系）
        {
            ...
            for(int i=0;i<nBoss;i++){
                ...
                if(!(x>range_CF.getMinX()&&x<range_CF.getMaxX()
                     ...
                     &&z>range_CF.getMinZ()&&z<range_CF.getMaxZ())){//如果出界
    ...
    //----初始化mobilePlatform的碰撞网格
    {
        ...
        float d_ccell=maxRc;//格子边长
        //mobilePlatform的碰撞网格范围为所有mobilePlatform的startPos和endPos的范围
    ...
    //----初始化bubble的碰撞网格
    {
        ...
        //更新collisionGrid，只在初始化时更新即可，因为bubble都是不动的
        {
            //制作屏蔽列表
            int n=(int)m_bubbleSet.getActorCount();
            vector<bool> maskList(n);//屏蔽列表
            for(int i=0;i<n;i++)maskList[i]=false;
            m_collisionGrid_bubble.fillGrid(m_bubbleSet.getActorList(),maskList);
            /*   for(int i=0;i<bubbleSet.getModelCount();i++){
             Cbubble*bubble=(Cbubble*)bubbleSet.getModelByIndex(i);
             bubble->getPos().print();
             }*/
        }
...
//------------------------------------------------------------------------------------------------------------------------------------
    //--quad_oops
    {
        ...
        m_quad_oops->getModelList()[0]->getMeshByIndex(0)->submit(GL_STATIC_DRAW);
        //设为不可见
    ...
    //--quad_out_of_fuel
    {
        ...
        m_quad_out_of_fuel->getModelList()[0]->getMeshByIndex(0)->submit(GL_STATIC_DRAW);
        //设为不可见
    ...
    //--quad_halfFuelHaveBeenUsed
    {
        ...
        m_quad_halfFuelHaveBeenUsed->getModelList()[0]->getMeshByIndex(0)->submit(GL_STATIC_DRAW);
        //设为不可见
...
//------------------------------------------------------------------------------------------------------------------------------------
      ...
      //--quad_depthTex
    {
        ...
        m_quad_depthTex->getModelList()[0]->getMeshByIndex(0)->getIndexVBO()->genBuffers();
        m_quad_depthTex->getModelList()[0]->getMeshByIndex(0)->setTexture(m_depthTex);
    ...
    //--quad_depthTex2
    {
        ...
        m_quad_depthTex2->getModelList()[0]->getMeshByIndex(0)->getIndexVBO()->genBuffers();
        m_quad_depthTex2->getModelList()[0]->getMeshByIndex(0)->setTexture(m_depthTex2);
    ...
    //--tipKey
    {
        ...
        m_tipKey->getModelList()[0]->getMeshByIndex(0)->getIndexVBO()->genBuffers();
        ...
        m_tipKey->getModelList()[0]->getMeshByIndex(0)->submit(GL_STATIC_DRAW);
        //
    ...
    //--pauseKey
    {
        ...
        m_pauseKey->getModelList()[0]->getMeshByIndex(0)->getIndexVBO()->genBuffers();
        ...
        m_pauseKey->getModelList()[0]->getMeshByIndex(0)->submit(GL_STATIC_DRAW);
        //
    ...
    //--zoomOutKey
    {
        ...
        m_zoomOutKey->useKeyUpColor();
        m_zoomOutKey->getModelList()[0]->getMeshByIndex(0)->setTexture(ptex_zoomOut);
        ...
        m_zoomOutKey->getModelList()[0]->getMeshByIndex(0)->submit(GL_STATIC_DRAW);
        //
  ...
  //      ptex_shotBigKey_adjusting=Cc3dTextureCache::sharedTextureCache()->addImage("data/global/tex/keys/key_shot_big_adjusting.png");
        ...
        m_shotBigKey->useKeyUpColor();
        m_shotBigKey->getModelList()[0]->getMeshByIndex(0)->setTexture(ptex_shotBigKey);
    ...
    //--shotKey
    {
        ...
        m_shotKey->useKeyUpColor();
        m_shotKey->getModelList()[0]->getMeshByIndex(0)->setTexture(ptex_shotKey);
    ...
    //--goDownShipKey
    {
        ...
        m_goDownShipKey->useKeyUpColor();
        m_goDownShipKey->getModelList()[0]->getMeshByIndex(0)->setTexture(ptexture_goDownShipKey);
        ...
        m_goDownShipKey->getModelList()[0]->getMeshByIndex(0)->submit(GL_STATIC_DRAW);
        //
    ...
    //---lifeBar
    {
        ...
        //quad_front
        m_lifeBar->getQuadFront()->getModelList()[0]->getMeshByIndex(0)->submit(GL_STATIC_DRAW);
        //
    ...
    //----quad_keyList
    {
        ...
        for(int i=0;i<nKey;i++){
            ...
            quad_key->getModelList()[0]->getMeshByIndex(0)->getIndexVBO()->genBuffers();
        ...
        //在quad_keyList中先前nkey个quad_key进行绘制
        ...
        for(int i=0;i<nkey;i++){
            Ckey*quad_key=m_quad_keyList[i];
            quad_key->getModelList()[0]->getMeshByIndex(0)->submit(GL_STATIC_DRAW);
        }
    }
    //----quad_coin
    {
        ...
        m_quad_coin->getModelList()[0]->getMeshByIndex(0)->submit(GL_STATIC_DRAW);
        //
    ...
    //----quad_nCoinPositivePlaceList
    {
        ...
        for(int i=0;i<nPositivePlace;i++){
            ...
            quad->getModelList()[0]->getMeshByIndex(0)->getIndexVBO()->genBuffers();
            quad->getModelList()[0]->getMeshByIndex(0)->setTexture(m_numberTexList[0]);
        ...
        for(int i=0;i<nPositivePlace;i++){
            ...
            quad->getModelList()[0]->getMeshByIndex(0)->submit(GL_STATIC_DRAW);
        }
    }
    //----quad_killEnemy
    {
        ...
        m_quad_killEnemy->getModelList()[0]->getMeshByIndex(0)->submit(GL_STATIC_DRAW);
        //
    ...
    //---fuelBar
    {
        ...
        m_fuelBar->getQuadFront()->getModelList()[0]->getMeshByIndex(0)->submit(GL_STATIC_DRAW);
        //
        m_uiRoot->addChild(m_fuelBar);
        //根据shipSet是否为空决定是否显示fuelBar
      //  cout<<"ship count:"<<m_shipSet.getModelCount()<<endl;
...
void  CplayingPage::visitDraw(){
    ...
    //------------------------渲染shadow map--------------------
    {
        ...
        if(m_depthTex_got==false){
            ...
            Cc3dVector4 center(cx,cy,cz,1);//看向场景中心
            ...
            glDepthMask(GL_TRUE);
            glClear(GL_DEPTH_BUFFER_BIT);//只有深度缓存，所以只清除深度缓存，另外tile-base architecture要求bind之后立即clear更快些
            glViewport(0, 0, m_depthTex->getWidth() , m_depthTex->getHeight());//离屏窗口
        ...
        //设置光源视角
        float center[4]={cellPos.x(),cellPos.y(),cellPos.z(),1};//看主角
        ...
        glDepthMask(GL_TRUE);
        glClear(GL_DEPTH_BUFFER_BIT);//只有深度缓存，所以只清除深度缓存，另外tile-base architecture要求bind之后立即clear更快些
        glViewport(0, 0, m_depthTex2->getWidth() , m_depthTex2->getHeight());//离屏窗口
    ...
    //根据主角位置计算相机的目标位置
    Cc3dVector4 eyePos_tg=m_cell->getTransform().convertToWorldSpace(m_eyePosInCell);//目标相机位置
    //计算软移动后实际相机位置
    Cc3dVector4 eyePos_real;
    const float k=(m_cell->get_onShip()?0.1:0.25);
    eyePos_real=softMov(eyePos, eyePos_tg, k);
    Cc3dVector4 up(0,1,0,0);//向上向量
    ...
    //绘图
    {
        ...
        glEnable(GL_BLEND);
        {
            ...
            if((int)m_archScene->getModel()->getMeshCount()>=1){
                float oldDiffuseAlpha=m_archScene->getModel()->getMeshByIndex(0)->getMaterial()->getDiffuse().a();
                Ec3dCullFace oldCullFace=m_archScene->getModel()->getMeshByIndex(0)->getCullFace();
...
void  CplayingPage::makeSound(){//必须加static
    ...
    Cship*pship=m_cell->get_ship();
    if(pship){
        if(m_cell->fuel.value!=0){//有燃料才有声音
            //根据速度设定音量大小
            ...
            float backSoundWeight=0.3;//背景音权重
