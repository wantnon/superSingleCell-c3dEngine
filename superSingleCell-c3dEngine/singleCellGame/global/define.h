...
//----敌人参数
const float MHD_bossCellMidFar=600;//距主角的曼哈顿距离超过此值，认为bossCell中等远
const float MHD_bossCellTooFar=900;//距主角的曼哈顿距离越过此值，认为bossCell很远
//----地形尺寸
const float blockWidth=331.371*8.67;
const float blockHeight=331.371*8.67;
//----相机相对于cell的位置
const float eyePosInCell_normal[4]={0,32*2,60*2,1};//正常情况下cell坐标系下相机的位置
const float k_eyePosInCell_zoomOut=10;//在拉远情况下相机相对于cell的位置的放大倍数
//----共享纹理挂接点
//GL_TEXTURE1: shadow map1
//GL_TEXTURE2: 挂shadow map2
//GL_TEXTURE3: 挂水面alpha纹理
//GL_TEXTURE4: 挂地面alpha纹理
