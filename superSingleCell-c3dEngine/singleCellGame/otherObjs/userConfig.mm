...
bool CuserConfig::getIsConfigFileExistInDocuments(const string&filePath){
    ...
    NSString *fileFullPath_NS=[[[NSString alloc] initWithUTF8String:fileFullPath.c_str()] autorelease];
    //判断路径subClipOrFilePathFull_NS是否存在
    bool isExist =  [[NSFileManager defaultManager] fileExistsAtPath:fileFullPath_NS];
    return isExist;
